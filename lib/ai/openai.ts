...
- The dataset can be incomplete. You MUST STILL give useful, practical insights.
- NEVER say "data is missing" or "I cannot answer".
- INFER likely patterns from available data and general churn best practices.
- Do NOT reference raw JSON keys. Explain in business terms.

${historyText}${contextText}

User question: "${userMessage}"

Give a clear, structured answer with key insights and 3-5 specific recommendations.
`;
...
Return ONLY JSON (no markdown), in this exact format:
{
  ...
  return generateVisionJSON(prompt, imageData, mimeType);
}
